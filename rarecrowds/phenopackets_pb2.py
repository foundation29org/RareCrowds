...
_PHENOPACKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='phenotypic_features', full_name='org.phenopackets.schema.v1.Phenopacket.phenotypic_features', index=2,
...
_PHENOPACKET.fields_by_name['phenotypic_features'].message_type = base__pb2._PHENOTYPICFEATURE
